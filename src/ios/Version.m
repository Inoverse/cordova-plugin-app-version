...
- (void)getInfos:(CDVInvokedUrlCommand*)command
{
    ...
    [returnInfo setObject:[messageAsString:appName] forKey:@"appName"];
    [returnInfo setObject:[messageAsString:packageName] forKey:@"packageName"];
    [returnInfo setObject:[messageAsString:versionNumber] forKey:@"versionNumber"];
    [returnInfo setObject:[messageAsString:versionCode] forKey:@"versionCode"];
